<template>
    <section class="player" @touchstart="toFull">
        ...
        <Icon v-show="playing" class="icon" type="12" :size="setRem(24)" @touchstart.native.stop="pause" />
        <Icon v-show="!playing" class="icon" type="8" :size="setRem(24)" @touchstart.native.stop="play(null)" />

        <Icon class="icon" type="1" :size="setRem(24)" @touchstart.native.stop="showList" />
